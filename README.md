...
1.  **Place your video file** (e.g., `lecture.mp4`) in the project directory or an `input/` folder.

2.  **Run the main script:**
    (Adjust the video path and your API key handling as needed)
    ```bash
    python main.py --video_path "path/to/your/lecture.mp4"
    ```

3.  **View the output:**
    * The pipeline will run through all 5 phases, showing progress in the console.
    * The final, clean summary will be saved as **`lecture_summary.md`**.
    * All intermediate files (keyframes, enhanced images, and the raw transcript) will be available in the `workspace/` directory for review.
